 ...
 * @link https://mini-php-framework.googlecode.com/
 */
class Handler extends \SF\Event\Error\Handler {
	public function eventProccess() {
		...
		if (0 == error_reporting () || APP_ENV == APP_ENV_PRODUCTION) {
			...
			if($errType == in_array($errType, array(\SF\Event\Error\Handler::getErrTypeName(\SF\Event\Error\Handler::ERROR_TYPE_FATAL), SF\Event\Error\Handler::ERR_TYPE_EXCEPTION ))){
