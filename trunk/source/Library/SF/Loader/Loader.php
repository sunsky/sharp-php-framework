...
final class Loader {
	 ...
	 * @return string | bool
	 * @throws \SF\Exception\SysException
	 */
		...
		try{
			if(!class_exists($className, false)){
				...
				if ($resolvedPath !== false) {
					...
					throw new InvalidClassException(sprintf('class %s is not found in %s:%u',$className,\SF\Event\Error\Handler::getRelativePath(__FILE__)  ,__LINE__));
				}
			}
...
require 'SF/Event/Exception/Exception.php';
class InvalidClassException extends \SF\Event\Exception\Exception{
}
